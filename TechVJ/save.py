...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("❣️ Developer", url = "https://t.me/skcreator7")
    ],[
        InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+_AWkWy0499dlZjQ1'),
        InlineKeyboardButton('🤖 BackUp Cʜᴀɴɴᴇʟ', url='https://t.me/skcreatorBackup')
	]]
